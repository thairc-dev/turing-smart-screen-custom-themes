...
class AppConfig:
    ...
    log_level: str = "INFO"
    log_file: Path | None = Path("logs/nova01.log")
...
def load_config(path: str | Path | None = None) -> AppConfig:
    ...
    if (display.width, display.height) != (480, 320):
        raise ValueError("TRUE VIEW 26 currently supports only the 480x320 landscape 3.5-inch panel")
    ...
    return AppConfig(
        ...
        log_file=_resolve_path(log_file_value, base, base / "trueview26.log") if log_file_value else None,
    )
