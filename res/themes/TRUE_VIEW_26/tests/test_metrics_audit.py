...
from trueview26.metrics import MetricsCollector, classify_health, network_rate_mb_s
...
class MetricsAuditTests(unittest.TestCase):
    ...
    def test_apfs_uses_container_not_read_only_snapshot(self) -> None:
        ...
        with (
            patch("trueview26.metrics.platform.system", return_value="Darwin"),
            patch("trueview26.metrics.subprocess.check_output", return_value=payload),
        ):
