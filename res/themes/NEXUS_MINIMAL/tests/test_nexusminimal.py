...
from nexusminimal.config import THEME_ROOT, load_config
from nexusminimal.metrics import MetricsCollector, MetricsSnapshot, SystemInfo
from nexusminimal.protocol import CLEAR, DISPLAY_BITMAP, SCREEN_OFF, build_command, image_to_rgb565le
from nexusminimal.renderer import cleanse_display, format_rate, format_uptime, render_session
from nexusminimal.transports.preview_transport import PreviewTransport
...
class NexusMinimalTests(unittest.TestCase):
    ...
    def test_startup_cleanse_ends_on_full_black_frame(self) -> None:
        ...
        with patch("nexusminimal.renderer.time.sleep"):
