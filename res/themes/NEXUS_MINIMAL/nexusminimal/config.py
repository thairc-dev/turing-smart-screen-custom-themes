...
def load_config(path: str | Path | None = None) -> AppConfig:
    ...
    if (display.width, display.height) != (480, 320):
        raise ValueError("NEXUS MINIMAL currently supports only the 480x320 landscape 3.5-inch panel")
    ...
    return AppConfig(
        ...
        log_file=_resolve_path(log_file_value, base, base / "nexusminimal.log") if log_file_value else None,
    )
